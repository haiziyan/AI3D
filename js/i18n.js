    ...
    getTranslations() {
        return {
            'zh-CN': {
                ...
                // AI模块
                'ai.title': 'AI 模型生成',
                'ai.placeholder': '描述你想要的3D模型，或对当前模型提出修改建议...',
                'ai.generate': '生成模型',
                'ai.history': '历史',
                'ai.newChat': '新对话',
                'ai.conversations': '对话列表',
                'ai.currentConversation': '当前对话',
                'ai.conversationHistory': '对话历史',
                'ai.newConversation': '开始新对话',
                'ai.newConversationDesc': '输入描述开始生成3D模型',
                'ai.emptyConversation': '对话为空',
            ...
            'zh-TW': {
                ...
                // AI模組
                'ai.title': 'AI 模型生成',
                'ai.placeholder': '描述你想要的3D模型，或對當前模型提出修改建議...',
                'ai.generate': '生成模型',
                'ai.history': '歷史',
                'ai.newChat': '新對話',
                'ai.conversations': '對話列表',
                'ai.currentConversation': '當前對話',
                'ai.conversationHistory': '對話歷史',
                'ai.newConversation': '開始新對話',
                'ai.newConversationDesc': '輸入描述開始生成3D模型',
                'ai.emptyConversation': '對話為空',
                'ai.noConversations': '暫無對話',
            ...
            'en': {
                ...
                'ai.title': 'AI Model Generation',
                'ai.placeholder': 'Describe your 3D model or suggest modifications to the current model...',
                ...
                'ai.newConversation': 'Start New Conversation',
                'ai.newConversationDesc': 'Enter description to generate 3D model',
                'ai.emptyConversation': 'Empty Conversation',
            ...
            'ja': {
                ...
                // AIモジュール
                'ai.title': 'AI モデル生成',
                'ai.placeholder': '3Dモデルを説明するか、現在のモデルへの変更を提案してください...',
                'ai.generate': 'モデルを生成',
                'ai.history': '履歴',
                'ai.newChat': '新しい会話',
                'ai.conversations': '会話リスト',
                'ai.currentConversation': '現在の会話',
                'ai.conversationHistory': '会話履歴',
                'ai.newConversation': '新しい会話を開始',
                'ai.newConversationDesc': '説明を入力して3Dモデルを生成',
                'ai.emptyConversation': '会話が空です',
                'ai.noConversations': '会話がありません',
            ...
            'ko': {
                ...
                // AI 모듈
                'ai.title': 'AI 모델 생성',
                'ai.placeholder': '3D 모델을 설명하거나 현재 모델에 대한 수정을 제안하세요...',
                'ai.generate': '모델 생성',
                'ai.history': '기록',
                'ai.newChat': '새 대화',
                'ai.conversations': '대화 목록',
                'ai.currentConversation': '현재 대화',
                'ai.conversationHistory': '대화 기록',
                'ai.newConversation': '새 대화 시작',
                'ai.newConversationDesc': '설명을 입력하여 3D 모델 생성',
                'ai.emptyConversation': '대화가 비어 있습니다',
                'ai.noConversations': '대화가 없습니다',
            ...
            'de': {
                ...
                // KI-Modul
                'ai.title': 'KI-Modellgenerierung',
                'ai.placeholder': 'Beschreiben Sie Ihr 3D-Modell oder schlagen Sie Änderungen am aktuellen Modell vor...',
                'ai.generate': 'Modell generieren',
                'ai.history': 'Verlauf',
                'ai.newChat': 'Neuer Chat',
                'ai.conversations': 'Gespräche',
                'ai.currentConversation': 'Aktuelles Gespräch',
                'ai.conversationHistory': 'Gesprächsverlauf',
                'ai.newConversation': 'Neues Gespräch starten',
                'ai.newConversationDesc': 'Beschreibung eingeben, um 3D-Modell zu generieren',
                'ai.emptyConversation': 'Leeres Gespräch',
                'ai.noConversations': 'Keine Gespräche',
            ...
            'fr': {
                ...
                // Module IA
                'ai.title': 'Génération de modèle IA',
                'ai.placeholder': 'Décrivez votre modèle 3D ou suggérez des modifications au modèle actuel...',
                'ai.generate': 'Générer le modèle',
                'ai.history': 'Historique',
                'ai.newChat': 'Nouvelle conversation',
                'ai.conversations': 'Conversations',
                'ai.currentConversation': 'Conversation actuelle',
                'ai.conversationHistory': 'Historique des conversations',
                'ai.newConversation': 'Démarrer une nouvelle conversation',
                'ai.newConversationDesc': 'Entrez une description pour générer un modèle 3D',
                'ai.emptyConversation': 'Conversation vide',
                'ai.noConversations': 'Aucune conversation',
            ...
            'es': {
                ...
                // Módulo IA
                'ai.title': 'Generación de modelo IA',
                'ai.placeholder': 'Describe tu modelo 3D o sugiere modificaciones al modelo actual...',
                'ai.generate': 'Generar modelo',
                'ai.history': 'Historial',
                'ai.newChat': 'Nueva conversación',
                'ai.conversations': 'Conversaciones',
                'ai.currentConversation': 'Conversación actual',
                'ai.conversationHistory': 'Historial de conversaciones',
                'ai.newConversation': 'Iniciar nueva conversación',
                'ai.newConversationDesc': 'Ingresa una descripción para generar un modelo 3D',
                'ai.emptyConversation': 'Conversación vacía',
                'ai.noConversations': 'Sin conversaciones',
            ...
            'it': {
                ...
                // Modulo IA
                'ai.title': 'Generazione modello IA',
                'ai.placeholder': 'Descrivi il tuo modello 3D o suggerisci modifiche al modello attuale...',
                'ai.generate': 'Genera modello',
                'ai.history': 'Cronologia',
                'ai.newChat': 'Nuova conversazione',
                'ai.conversations': 'Conversazioni',
                'ai.currentConversation': 'Conversazione attuale',
                'ai.conversationHistory': 'Cronologia conversazioni',
                'ai.newConversation': 'Inizia nuova conversazione',
                'ai.newConversationDesc': 'Inserisci una descrizione per generare un modello 3D',
                'ai.emptyConversation': 'Conversazione vuota',
                'ai.noConversations': 'Nessuna conversazione',
            ...
            'pt': {
                ...
                // Módulo IA
                'ai.title': 'Geração de modelo IA',
                'ai.placeholder': 'Descreva seu modelo 3D ou sugira modificações ao modelo atual...',
                'ai.generate': 'Gerar modelo',
                'ai.history': 'Histórico',
                'ai.newChat': 'Nova conversa',
                'ai.conversations': 'Conversas',
                'ai.currentConversation': 'Conversa atual',
                'ai.conversationHistory': 'Histórico de conversas',
                'ai.newConversation': 'Iniciar nova conversa',
                'ai.newConversationDesc': 'Digite uma descrição para gerar um modelo 3D',
                'ai.emptyConversation': 'Conversa vazia',
                'ai.noConversations': 'Sem conversas',
            ...
            'vi': {
                ...
                // Mô-đun AI
                'ai.title': 'Tạo mô hình AI',
                'ai.placeholder': 'Mô tả mô hình 3D của bạn hoặc đề xuất sửa đổi cho mô hình hiện tại...',
                'ai.generate': 'Tạo mô hình',
                'ai.history': 'Lịch sử',
                'ai.newChat': 'Cuộc trò chuyện mới',
                'ai.conversations': 'Cuộc trò chuyện',
                'ai.currentConversation': 'Cuộc trò chuyện hiện tại',
                'ai.conversationHistory': 'Lịch sử trò chuyện',
                'ai.newConversation': 'Bắt đầu cuộc trò chuyện mới',
                'ai.newConversationDesc': 'Nhập mô tả để tạo mô hình 3D',
                'ai.emptyConversation': 'Cuộc trò chuyện trống',
                'ai.noConversations': 'Không có cuộc trò chuyện',
            ...
            'ar': {
                ...
                'ai.title': 'إنشاء نموذج الذكاء الاصطناعي',
                'ai.placeholder': 'صف نموذجك ثلاثي الأبعاد أو اقترح تعديلات على النموذج الحالي...',
                'ai.generate': 'إنشاء نموذج',
                'ai.history': 'السجل',
                'ai.newChat': 'محادثة جديدة',
                'ai.conversations': 'المحادثات',
                'ai.currentConversation': 'المحادثة الحالية',
                'ai.conversationHistory': 'سجل المحادثات',
                'ai.newConversation': 'بدء محادثة جديدة',
                'ai.newConversationDesc': 'أدخل وصفًا لإنشاء نموذج ثلاثي الأبعاد',
                'ai.emptyConversation': 'محادثة فارغة',
                'ai.noConversations': 'لا توجد محادثات',
